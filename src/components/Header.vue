...
<div>
  ...
  <div>
      <b-navbar-nav>
        <b-nav-item exact-active-class="active" to="dashboard"> Dashboard </b-nav-item>
          <b-nav-item exact-active-class="active" to="booking"> Booking </b-nav-item>
      </b-navbar-nav>
  </div>
  ...
  <!-- <header>
    <nav class="container">
      <div class="branding">
        <router-link class="header" :to="{ name: 'dashboard' }"
